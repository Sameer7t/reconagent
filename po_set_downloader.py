...
OUTPUT_DIR = PROJECT_ROOT / "dataset" / "standalone" / "purchase_orders"

# ==========================================
# DOWNLOAD CONSTANTS
# ==========================================
REPO_ID = "AyoubChLin/northwind_PurchaseOrders"
MAX_DOWNLOADS = 480
...
logger = logging.getLogger("PurchaseOrderDownloader")
...
def download_purchase_orders():
    ...
    try:
        ...
        # Filter for standard document formats
        document_files = [
            f for f in files
        ...
        # Critical catch to prevent overall script crash
