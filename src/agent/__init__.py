...
Provides state definitions, evidence provenance models, finding representations,
action protocols, policies, post-validation, review queues, relational persistence,
and evaluation metrics for autonomous invoice discrepancy investigation.
"""
